...
func (e *EnumerationAccessDeniedAlert) GetProviderMessage() string {
	...
	case github.RemoteGithubTerraform:
		message += "Please be sure that your Github token have the right permissions, check the last up-to-date documentation there : https://docs.driftctl.com/providers/github/authentication#least-privileged-policy"
