...
func TestVPC(t *testing.T) {
	...
	for _, c := range tests {
		t.Run(c.test, func(tt *testing.T) {
			...
			remoteLibrary.AddDetailsFetcher(resourceaws.AwsVpcResourceType, aws.NewVPCDetailsFetcher(provider, deserializer))
			remoteLibrary.AddDetailsFetcher(resourceaws.AwsDefaultVpcResourceType, aws.NewVPCDetailsFetcher(provider, deserializer))
